 ...
 *
 * @param chartCode The Chart.js configuration JSON string
 * @param modifier Modifier to be applied to the chart
 */
@Composable
internal fun ChartDiagram(
    chartCode: String,
    modifier: Modifier = Modifier,
) {
    val htmlContent = remember(chartCode) {
        buildHtmlContent(chartCode.escapeJson())
    }
    AndroidView(
        modifier = modifier,
        factory = { context ->
